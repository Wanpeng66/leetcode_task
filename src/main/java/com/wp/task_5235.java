...
/**
 * @author: wp
 * @Title: task_5235  5235. 找出输掉零场或一场比赛的玩家
 * @Description: https://leetcode-cn.com/contest/weekly-contest-287/problems/find-players-with-zero-or-one-losses/
 * @date 2022/4/3 10:50
 */
public class task_5235 {
    ...
    public static List<List<Integer>> findWinners( int[][] matches) {
        ...
        for (int i = 0; i < matches.length; i++) {
            ...
            /*if (win.containsKey( matches[i][1] )) {
                win.remove( matches[i][1] );
            }*/
        }
        List<List<Integer>> res = new ArrayList<>();
        Set<Integer> set1 = win.keySet();
        Set<Integer> set2 = lose.keySet();
        set1.removeAll( set2 );
        List<Integer> winList = new ArrayList<>(set1);
        ...
        winList.sort( ( o1, o2 ) -> o1-o2 );
        loseList.sort( ( o1, o2 ) -> o1-o2 );
        res.add( 0,winList );
        res.add( 1,loseList );
        return res;
    }
